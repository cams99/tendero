      ...
      <Row>
        <Col xs={18} sm={18} md={18} lg={18}>
          <Search
            ...
            className={'tendero-table-search customSearch'}
            size={'large'}
                  ...
                  expandable={{
                    expandedRowRender: record => (
                      <div className={'text-left'}>
                        <p>
                          <b>Género: </b> {record.sex === 'MALE' ? 'MASCULINO' : 'FEMENINO'}
                        </p>
                        <p>
                          <b>Género Reconocimiento Facial: </b> {record.biometric_id !== null ? 'Si' : 'No'}{' '}
                        </p>
                        <p>
                          <b>Tipo de Edad: </b> {Utils.getAge(record.birthdate) >= 18 ? 'Adulto' : 'Menor de edad'}{' '}
                        </p>
                      </div>
                    ),

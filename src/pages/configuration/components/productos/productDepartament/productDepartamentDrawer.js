...
function ProductDepartamentDrawer(props) {
  /*VALUES*/
    ...
    <>
      <Drawer placement="right" closable={false} onClose={props.closable} visible={props.visible} width={800}>
        <div className={'products-container-combo-tabs'}>
          <Title> {props.edit ? 'Editar departamento de producto' : 'Nuevo departamento de producto'} </Title>
          ...
          <Row gutter={16} className={'section-space-field'}>
            <Col xs={24} sm={24} md={24} lg={24}>
              ...
              <Input
                ...
                placeholder={'Ingrese nombre de departamento de productos'}
                size={'large'}
              />
            </Col>
          </Row>
...
export default ProductDepartamentDrawer
